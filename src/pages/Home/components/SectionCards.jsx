      ...
      <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
        <div className="px-4 py-5 flex-auto">
          ...
          <p className="mt-2 mb-4 text-blueGray-500">
           Lunes a viernes: 8 a.m. a 8 p.m.<br/>
      ...
      <div className="w-full md:w-4/12 px-4 text-center">
        <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
          <div className="px-4 py-5 flex-auto">
            ...
            <br/>
            ✔️ Board Chipset B560 - ASUS / GIGABYTE / MSI<br/>
            ✔️ 16gb en Memoria Ram DDR4 3200Mhz Blindada RGB<br/>
            ✔️ T. Video NVIDIA GTX 1650 4GB GDDR6<br/>
            ✔️ 240gb Disco Estado Solido<br/>
            ✔️ Chasis Gamer AEROCOOL / THERMALTAKE / C.MASTER / GAMEMAX<br/>
            ✔️ Fuente Real de 600W 80 Plus<br/>
            </p>
          </div>
        </div>
      </div>
